...
function useWebStyles() {
  useEffect(() => {
    ...
    const noiseSvg = `url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.06'/%3E%3C/svg%3E")`;
    style.textContent = [
    ...
    // Apply paper grain texture as background-image on panel elements
    function tagPanels() {
      document.querySelectorAll("div").forEach((el) => {
        ...
        if (bg === "rgb(248, 241, 232)" || bg === "#f8f1e8") {
          el.dataset.grain = "1";
          el.style.backgroundImage = noiseSvg;
