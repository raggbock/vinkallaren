...
export const K = {
  ...
  sessionParticipants: (id: string) => `tasting:session:${id}:participants`,
  sessionDishes: (id: string) => `tasting:session:${id}:dishes`,
  sessionTastingDishes: (id: string) => `tasting:session:${id}:tasting_dishes`,
  queue: "tasting:queue",
