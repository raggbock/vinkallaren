...
-- Autocomplete: fuzzy search across name and producer
-- OCR text excluded from autocomplete (too noisy, adds ~1.5s)
-- OCR matching stays available via match_catalog_by_text for camera workflow
